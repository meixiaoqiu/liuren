...
<section class="pan-block mt-4 bg-base-200/45 px-4 py-4 sm:px-5" aria-label="鬼墓判断过程">
    ...
    <p class="mt-2 text-sm leading-6 text-base-content/60">A' matcher：日鬼发用，且初传同时为日干墓或日支墓；否则不成立。</p>
    <div class="mt-4 grid gap-3 md:grid-cols-2">
        ...
        <div class="pan-block px-4 py-4 {{ ($trace['ghost_tomb_combined'] ?? false) ? 'bg-primary/10 ring-1 ring-primary/25' : 'bg-base-100/75' }}">
            <div class="flex items-center justify-between gap-3">
            ...
            <p class="mt-2 text-sm leading-6 text-base-content/65">A' 下命中本课即成立；不成立即不构成鬼墓课。</p>
        </div>
    </div>
