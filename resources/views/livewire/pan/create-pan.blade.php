                            ...
                            <div class="space-y-4">
                                ...
                                @foreach ($lessonInterpretations as $interpretation)
                                    <article class="flow-root py-1">
                                        ...
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.zhan_guan')
                                            @include('livewire.pan.partials.zhanguan-trace', ['trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.bikou')
                                            @include('livewire.pan.partials.lesson-trace', ['title' => '闭口判断', 'trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.youzi')
                                            @include('livewire.pan.partials.lesson-trace', ['title' => '游子判断', 'trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.sanjiao')
                                            @include('livewire.pan.partials.lesson-trace', ['title' => '三交判断', 'trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.zhuixu')
                                            @include('livewire.pan.partials.lesson-trace', ['title' => '赘婿判断', 'trace' => $interpretation['evidence']])
                                        @endif
                                        ...
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.wulu_juesi')
                                            @include('livewire.pan.partials.lesson-trace', ['title' => '无禄绝嗣判断', 'trace' => $interpretation['evidence']])
                                        @endif
                                        ...
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.xingshang')
                                            @include('livewire.pan.partials.xingshang-trace', ['trace' => $interpretation['evidence']])
                                        @endif

                                        @if ($interpretation['code'] === 'lesson.erfan')
                                            @include('livewire.pan.partials.erfan-trace', ['trace' => $interpretation['evidence']])
                                        @endif

                                        @if ($interpretation['code'] === 'lesson.tianhuo')
                                            @include('livewire.pan.partials.tianhuo-trace', ['trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.tianyu')
                                            @include('livewire.pan.partials.tianyu-trace', ['trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.tiankou')
                                            @include('livewire.pan.partials.tiankou-trace', ['trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.tianwang')
                                            @include('livewire.pan.partials.tianwang-trace', ['trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.pohua')
                                            @include('livewire.pan.partials.pohua-trace', ['trace' => $interpretation['evidence']])
                                        @endif
                                        ...
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.siqi')
                                            @include('livewire.pan.partials.siqi-trace', ['trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.zaie')
                                            @include('livewire.pan.partials.zaie-trace', ['trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.yangjiu')
                                            @include('livewire.pan.partials.yangjiu-trace', ['trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.jiuchou')
                                            @include('livewire.pan.partials.jiuchou-trace', ['trace' => $interpretation['evidence']])
                                        @endif
                                        ...
                                        @if ($interpretation['group'] === '励德课体')
                                            @include('livewire.pan.partials.grid-trace', ['title' => $interpretation['name'].'依据', 'trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['code'] === 'lesson.panzhu')
                                            @include('livewire.pan.partials.lesson-trace', ['title' => '盘珠判断', 'trace' => $interpretation['evidence']])
                                        @endif
                                        @if ($interpretation['group'] === '盘珠课体')
                                            @include('livewire.pan.partials.grid-trace', ['title' => $interpretation['name'].'依据', 'trace' => $interpretation['evidence']])
                                        @endif
