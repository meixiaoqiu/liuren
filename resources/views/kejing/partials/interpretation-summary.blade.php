...
<div class="flow-root" data-kejing-core-summary="shared">
    @if ($interpretation['guaSymbol'] !== null)
        <span
            class="float-right ml-4 mb-2 grid size-20 place-items-center bg-primary/10 text-4xl leading-none text-primary"
    ...
    @else
        <span
            class="float-right ml-4 mb-2 grid size-20 place-items-center bg-transparent text-4xl leading-none text-transparent"
    ...
    <div class="flex items-start gap-3" data-kejing-pan-heading="compact">
    ...
    <p class="mt-1 leading-7 text-base-content/65">{{ $descriptionSource }}</p>
    @if ($xiangSource !== null)
