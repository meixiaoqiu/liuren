    ...
    public function definition(): array
    {
        return [
            ...
            'judgments' => [
                ...
                ['code' => 'grid_seasonal_state_wang', 'effect' => 'increase', 'label' => '局五行时令旺', 'description' => '全局所属五行在当前四立／土旺十八日口径下为旺。'],
                ['code' => 'grid_seasonal_state_xiang', 'effect' => 'increase', 'label' => '局五行时令相', 'description' => '全局所属五行在当前四立／土旺十八日口径下为相。'],
                ['code' => 'grid_seasonal_state_xiu', 'effect' => 'neutral', 'label' => '局五行时令休', 'description' => '全局所属五行在当前四立／土旺十八日口径下为休。'],
                ['code' => 'grid_seasonal_state_qiu', 'effect' => 'reduce', 'label' => '局五行时令囚', 'description' => '全局所属五行在当前四立／土旺十八日口径下为囚。'],
                ['code' => 'grid_seasonal_state_si', 'effect' => 'reduce', 'label' => '局五行时令死', 'description' => '全局所属五行在当前四立／土旺十八日口径下为死。'],
                ['code' => 'initial_seasonal_state_wang', 'effect' => 'increase', 'label' => '初传时令旺', 'description' => '初传在当前时令为旺；与整个局五行旺衰分开判断。'],
                ['code' => 'initial_seasonal_state_xiang', 'effect' => 'increase', 'label' => '初传时令相', 'description' => '初传在当前时令为相；与整个局五行旺衰分开判断。'],
                ['code' => 'initial_seasonal_state_xiu', 'effect' => 'neutral', 'label' => '初传时令休', 'description' => '初传在当前时令为休；与整个局五行旺衰分开判断。'],
                ['code' => 'initial_seasonal_state_qiu', 'effect' => 'reduce', 'label' => '初传时令囚', 'description' => '初传在当前时令为囚；与整个局五行旺衰分开判断。'],
                ['code' => 'initial_seasonal_state_si', 'effect' => 'reduce', 'label' => '初传时令死', 'description' => '初传在当前时令为死；与整个局五行旺衰分开判断。'],
