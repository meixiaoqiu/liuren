...
final class CuiGuanShiZheRule implements BiFaRule
{
    ...
    public function definition(): array
    {
        return [
            ...
            'sections' => [
                ...
                ['title' => '返本煞只作迟任判断、不作成立入口', 'content' => '返本煞不作为第四法的独立成立条件。若盘面已经满足上述四项成立条件中的任意一项，恰好三传又组成当季返本局，则附加一条返本煞减损断义。返本煞绝不单独触发第四法。'],
                ...
                ['title' => '乙卯昼贵空、己卯夜贵空的特殊边界', 'content' => '「不用」二字是正文明确给出的特例：乙卯日属甲寅旬，子丑空，昼贵子恰逢旬空；仅当某个恩主举荐判断完全依靠该昼贵子作父母爻时，不得据此成立，其他父母爻位置不受影响。己卯日属甲戌旬，申酉空，夜贵申恰逢旬空；“长生作贵人”这一项不成立，但“父母爻”这一项仍可由其它位置成立。这两个特例不扩展到「所有父母爻旬空都不成立」或「所有长生贵人旬空都不成立」。'],
            ],
        ];
    }
    ...
    public function match(PanFacts $facts): ?BiFaRuleMatch
    {
        ...
        if ($route4Matched) {
            ...
            $nobleDetail = '己卯日夜贵申恰为长生贵人，但申落旬空，正文明确「不用」，故“长生作贵人”这一项不成立。';
        }
