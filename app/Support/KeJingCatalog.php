    ...
    public static function lessons(): array
    {
        $lessons = [
            ...
            [
                ...
                'source_examples' => [
                    ['label' => '甲子年七月乙巳日酉时巳将', 'path' => '天心格', 'source' => '《六壬大全》正文', 'detail' => '岁月日时皆在四课之中，为天心格；其中日支巳位于第三课下位，证明“四课之中”不能收窄为只检查四个上神。现代生产复现 2044-08-24 17:00：甲子年、申月、乙巳日、酉时、巳将。'],
                    ['label' => '辛亥日·三传戌酉申', 'path' => '回还格', 'source' => '《六壬大全》正文', 'detail' => '三传戌酉申皆在四课之中，正文只称回还格，不称盘珠，证明回还格可独立成立。现代生产复现 1900-02-07 01:00，三传确为戌、酉、申。'],
                    ['label' => '戊子日·子时·未将', 'path' => '回还格', 'source' => '《六壬大全》正文', 'detail' => '正文另举戊子日子时未将，明确称“三传俱在四课之上，为回还格”。现代生产复现 1900-07-14 00:00；另有 1900-07-13 23:00 晚子时样本，均为戊子日、子时、未将。'],
            ...
            [
                ...
                'gua' => '大畜',
                'guaSymbol' => '䷙',
                'summary' => '三传完整构成四组三合局之一，或三传全部属于辰戌丑未四季土；分别成润下、炎上、曲直、从革、稼穑五格。',
                'cases' => [
                    self::case(
                ...
                'source_examples' => [
                    ['label' => '三传申子辰、寅午戌、亥卯未、巳酉丑及辰戌丑未', 'path' => '全局课五格总定义', 'source' => '《六壬大全》正文', 'detail' => '正文以四组完整三合局分别定义润下、炎上、曲直、从革，并以三传四季土定义稼穑；五者同属全局。'],
                    ['label' => '五课外有寅卯辰等四方局', 'path' => '旁证扩展，不进入 matcher', 'source' => '《订讹》', 'detail' => '《订讹》明言“五课外”，故寅卯辰、巳午未、申酉戌、亥子丑不作为第58课或五格的成课入口。'],
                ],
            ],
            [
                'name' => '玄胎课',
                ...
                'gua' => '家人',
                'guaSymbol' => '䷤',
                'summary' => '三传俱孟，即初、中、末三传全部属于寅、巳、申、亥；进步长生为病胎，退步长生为生胎，反吟四孟为绝胎。',
                'cases' => [
                    self::case(
                        'lesson.xuantai.classic_jia_yin_yin_time_si_general',
                        '甲寅日·寅时·巳将·三传申亥寅（正文现代复现）',
                        '2031-09-11 03:00 为甲寅日、寅时；处暑后秋分前按项目月将口径为巳将。用于《六壬大全》正文课例的可点击现代复现。',
                        '2031-09-11T03:00',
                        self::DEFAULT_BIRTH,
                        self::DEFAULT_GENDER,
                        [],
                    ...
                    self::case(
                        'lesson.xuantai.bing_yin_shen_hai_yin',
                        '丙寅日·三传申亥寅（真实生产盘）',
                        '复用荣华课已经验证的真实生产盘：2001-05-03 11:00 三传申、亥、寅，三传全部属于四孟，因此稳定命中玄胎课。该案例用于程序回归，不冒充《大全》甲寅日正文课例。',
                        '2001-05-03T11:00',
                    ),
                ],
                'source_examples' => [
                    [
                        ...
                        'path' => '三传俱孟',
                        'source' => '《六壬大全》正文',
                        'detail' => '正文明确以甲寅日、寅时、巳将，三传申亥寅为玄胎课；正文课例卡使用 2031-09-11 03:00 作为现代复现，可直接点击排盘。',
                    ],
                    [
                        'label' => '进步长生病胎、退步长生生胎、反吟为绝胎',
                        'path' => '课内分型',
                        'source' => '《订讹》',
                        'detail' => '《订讹》以进步长生为病胎、主事速，以退步长生为生胎、主事迟，并称反吟课为绝胎；这些作为玄胎课后的分型，不扩大主体 matcher。',
                    ],
                ],
            ],
            [
                ...
                'gua' => '复',
                'guaSymbol' => '䷗',
                'summary' => '三传按十二支次序连续递进或递退，或三传依次为太岁、月建、日支（或逆序）；进退、岁月日顺逆及亥子丑三奇联珠作为课后判断。',
                'cases' => [
                    self::case(
                        'lesson.lianzhu.classic_yi_chou_you_time_xu_general',
                        '乙丑日·酉时·戌将·三传寅卯辰（正文现代复现）',
                        '2031-03-26 17:00 为乙丑日、酉时、戌将，生产盘三传寅、卯、辰，用于《六壬大全》正文课例的可点击现代复现。',
                        '2031-03-26T17:00',
                        self::DEFAULT_BIRTH,
                        self::DEFAULT_GENDER,
                        [],
                ...
                'source_examples' => [
                    [
                        'label' => '乙丑日·酉时·戌将·三传寅卯辰',
                        'path' => '三传连续递进',
                        'source' => '《六壬大全》正文',
                        'detail' => '正文明确以乙丑日、酉时、戌将，三传寅卯辰为连珠课；正文课例卡使用 2031-03-26 17:00 作为现代复现。',
                    ],
                    [
                        'label' => '顺连茹、逆连茹各十二课',
                        'path' => '十二顺 + 十二逆',
                        'source' => '《六壬大全》',
                        'detail' => '《六壬大全》另列“顺连茹三奇十二课”和“逆连茹三奇十二课”，包含子丑寅、辰巳午等连续三支。',
                    ],
                    [
                        'label' => '三传孟仲季相连，或三传岁月日相连',
                        'path' => '岁月日独立入口',
                        'source' => '《订讹》',
                        'detail' => '“或”连接两条独立成课路线；岁月日顺逆只记录快慢，不直接视作吉凶增减。',
                    ],
                ],
            ],
            [
            ...
            [
                ...
                'gua' => '革',
                'guaSymbol' => '䷰',
                'summary' => '四课四个上神全部同属阳或同属阴，初传为四课上神之一，中传、末传与四课上神同属该阴阳。',
                'cases' => [
                    self::case(
                        'lesson.liuchun.production_liuyang_20310104_0500',
                        '2031-01-04·卯时·六阳生产盘',
                        '生产盘四课上神为子、戌、寅、子，三传为寅、子、戌；四上神和中末传皆阳，初传寅又是四课上神之一，成立六阳课。',
                        '2031-01-04T05:00',
                        self::DEFAULT_BIRTH,
                        self::DEFAULT_GENDER,
                        [],
                    ...
                    self::case(
                        ...
                        '2031-01-03·卯时·六阴生产盘',
                        '生产盘四课上神为亥、酉、丑、亥，三传为亥、酉、未；四上神和中末传皆阴，初传亥又是四课上神之一，成立六阴课。',
                        '2031-01-03T05:00',
                        self::DEFAULT_BIRTH,
                        self::DEFAULT_GENDER,
                        [],
                    ...
                    self::case(
                        ...
                        '甲午日·干上子·退间传 戌申午·《六壬大全》正文例（原文参考盘·尚未完整复现）',
                        '《六壬大全》六纯正文明确以甲午日干上子为例，称六阳遇退间传，并明确提到初传戌，因此正文结构对应戌申午。当前生产程序对同一天地盘判定戌、寅为涉害候选，最终依现有涉害算法取寅，得到寅子戌。因此冲突位于"初传取用口径"，不是六纯课主体定义、天地盘结构或中末传顺传算法的问题。目前证据不足以证明现有取传算法错误，也不以单例古例修改核心涉害算法；该案例的现代代表盘 2024-01-31 03:00（寅时，子将）实际给出日柱甲午、干上子、六阳命中、三传寅子戌、jiuzongmen=涉害；当前涉害计数结果：戌=2，寅=6，仅记录实际值，不据此评判古法正误。',
                        '2024-01-31T03:00',
                        self::DEFAULT_BIRTH,
                        self::DEFAULT_GENDER,
                        [],
                    ...
                    self::case(
                        ...
                        '己卯日·酉加未·三传亥丑卯·《六壬大全》六阴主体结构现代复现',
                        '2024-01-16 21:00 复现己卯日、酉加未、四课上神酉亥巳未、三传亥丑卯及六阴主体；亥丑卯为每传顺行二支的顺间传·溟濛格。正文点名的昼将入夜、后合元、支干遇盗气、弹射发用、坐空等课后结构尚未验证，故只称主体结构复现。',
                        '2024-01-16T21:00',
                        self::DEFAULT_BIRTH,
                        self::DEFAULT_GENDER,
                        [],
                ...
                'source_examples' => [
                    [
                        'label' => '四课三传俱阳／俱阴与六阳六阴定义',
                        'path' => '六纯主体定义',
                        'source' => '《六壬大全》正文',
                        'detail' => '正文以“四课三传俱阳／俱阴”总述，并以“四课属阳／阴，中一课发用，并中末皆阳／阴”分别定义六阳、六阴。',
                    ],
                    [
                        'label' => '甲午日干上子·六阳遇退间传·倒拔蛇·悖戾',
                        'path' => '六阳正文例·原文参考盘',
                        'source' => '《六壬大全》正文',
                        'detail' => '六纯正文直接给出“甲午日干上子，六阳遇退间传，为倒拔蛇，名悖戾；及兼初传戌财，引入中末鬼乡”。间传正文另把戌申午列为悖戾格。2024-01-31 03:00 的天地盘与戌申午完全相容，但生产涉害取寅而非戌，故仍作为原文参考盘。',
                    ],
                    [
                        'label' => '己卯日酉加未·六阴遇昼将入夜',
                        'path' => '六阴正文例·主体结构现代复现',
                        'source' => '《六壬大全》正文',
                        'detail' => '正文依次写己卯日酉加未、六阴遇昼将入夜、昏迷尤甚，继写将乘后合元、支干遇盗气、弹射发用、坐空、问病必死、求望虚耗；随后才转入五阴及源消根断扩展。2024-01-16 21:00 已复现己卯、酉加未、四课、亥丑卯三传和六阴主体，未验证上述课后结构。',
                    ],
                    [
                        'label' => '五阳／五阴以人年命定之',
                        'path' => '年命填实扩展',
                        'source' => '《六壬大全》正文',
                        'detail' => '正文明确存在年命扩展，但“填之”的机器语义尚未完成课例验证，因此不进入主体 matcher。',
                    ],
                ],
            ],
            [
            ...
            [
                ...
                'cases' => [
                    self::case(
                        ...
                        '甲寅日·冬占·子水发用·子亥戌',
                        '《六壬大全》收束句为“甲寅日，冬占子水母，旺气用为新气，曰物类课也”，同时把这一课的完整课式写作三传子→亥→戌。重新扫描 1900-2100、Asia/Shanghai、每天十二个代表时辰（1900-01-01 至 2100-12-31 共 1223 个甲寅日），按“项目冬占口径 + 三传同时为 [子, 亥, 戌]”筛选，每年都能稳定命中 1–2 个真实生产盘；其中 2024-12-16 05:00:00 Asia/Shanghai 项目 PanCalculator 计算：日干支甲寅、卯时、冬占（2024-11-07 06:20:04 至 2025-01-16 22:10:28）、三传子亥戌、初传子水为旺、liuqin0 = 父母（2），与《大全》正文期望的完整课式逐项吻合，可同时作为《大全》正文课例与现代真实生产盘。该例保持 executable / daquan，经 PanRuleEngine 正式命中 lesson.wulei。',
                        '2024-12-16T05:00',
                        '1880-08-01T00:00',
                        self::DEFAULT_GENDER,
                        [],
                ...
                'source_examples' => [
                    [
                        'label' => '甲寅日·冬占·子水发用·子亥戌',
                        'path' => '子水父母、旺气正、正文完整复现',
                        'source' => '《六壬大全》正文',
                        'detail' => '2024-12-16 05:00 Asia/Shanghai 项目 PanCalculator 生产：日干支甲寅、卯时、冬占（2024-11-07 06:20:04 至 2025-01-16 22:10:28）、三传子亥戌、初传子水为旺、liuqin0=父母。该盘与《大全》正文期望的完整课式完全一致，作为 executable / daquan 课例入册。',
                    ],
                    [
                        'label' => '丙午日·三月占·三传寅午戌',
                        'path' => '三传火局、与日辰同类、火有气',
