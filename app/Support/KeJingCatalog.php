            ...
            [
                ...
                'cases' => [
                    ...
                    self::case(
                        ...
                        '壬午日·寅时·丑将（日鬼 + 日支墓）',
                        '日干壬对应正文日鬼为辰、戌；日支午属火，五行墓在戌。初传戌同时是日鬼与日支墓。',
                        '2026-01-08T03:00',
                    ),
                    self::case(
                ...
                'source_examples' => [
                    ['label' => '壬日辰发用', 'path' => '鬼墓兼见', 'source' => '《六壬大全》正文', 'detail' => '辰为壬日鬼、亦为壬水五行墓，辰发用即鬼墓兼见。现代复现时间为 2026-01-08 15:00。'],
                    ['label' => '凡日辰墓神及日鬼发用，为鬼墓课', 'path' => '正文主定义', 'source' => '《六壬大全》', 'detail' => '「日辰」在六壬语境中即日干与日支；正文同时给出「五行受鬼克贼，又加四墓，故名鬼墓」。'],
                    ['label' => '干支上神发用，或作干鬼干墓，或作支鬼支墓', 'path' => '《订讹》严格解释', 'source' => '《订讹》', 'detail' => '《订讹》在「鬼墓」一条下加按：既作日鬼，又作日墓，故名鬼墓。本程序 matcher 采用正文宽定义 A-prime，不引入支鬼（缺稳定古籍程序定义）。'],
                ],
            ],
        ];
    }
