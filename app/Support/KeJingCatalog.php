    ...
    public static function lessons(): array
    {
        return [
            ...
            [
                ...
                'cases' => [
                    self::case(
                        'lesson.zaie.hai_nian_yin_yue_yi_hai_mao_time_wei_initial',
                        '亥年·正月·乙亥日·卯时·初传未（正文古例现代复现）',
                        '《六壬大全·灾厄课》正文示例"亥年正月乙亥日卯时初传未"的现代生产复现：亥年（nianzhi=11）病符戌、丧门丑、吊客酉、岁虎未；正月（yuezhi=2）丧车未、游魂亥、伏殃酉、三丘丑、五墓未。初传未同时命中丧车、五墓、岁虎三路；正文古例中的"丧车 + 岁虎"重叠可由本盘完整复现。',
                        '1923-03-03T06:00',
                        '1900-01-01T00:00',
                    ),
                ],
                'source_examples' => [
                    ['label' => '亥年正月乙亥日卯时初传未', 'path' => '正文·月神丧车 + 岁神岁虎 同支重叠', 'source' => '《六壬大全·灾厄课》正文', 'detail' => '亥年正月乙亥日卯时，初传未；月建寅的丧车=未、亥年的岁虎=未，初传未同时命中两路。今已用 1923-03-03 06:00 在生产算法中完整复现，盘面三路命中：丧车（又名丧魂）、五墓、岁虎。'],
                ],
            ],
        ];
    }
