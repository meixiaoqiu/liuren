            ...
            [
                ...
                'cases' => [
                    ...
                    self::case(
                        ...
                        '甲午日·干上子·退间传 戌申午·《六壬大全》正文例（原文参考盘·尚未覆盖）',
                        '《六壬大全》正文原例：甲午日，干上子，六阳遇退间传 戌申午，为倒拔蛇、名悖戾；并兼初传戌财，引入中末鬼乡。干上子、四课三传全阳、退间传 戌申午 同盘成立的条件与当前生产盘取传机制互斥；2024-2026 年全部甲午日与 12 个代表时辰的扫描亦未找到任一盘使三传=戌申午，因此只能保留为原文参考盘，不修改取传算法、不修改涉害、不硬编码。',
                        '2024-01-31T03:00',
                        self::DEFAULT_BIRTH,
                        self::DEFAULT_GENDER,
                        [],
                    ...
                    self::case(
                        ...
                        '己卯日·酉加未·三传亥丑卯·《六壬大全》正文例现代完整复现',
                        '《六壬大全》正文原例：己卯日，酉加未，六阴遇昼将入夜，昏迷尤甚；正文给出的旁证三传为亥、丑、卯。2024-01-16 己卯日 21:00（亥时）生产盘完整复现：地盘未位上神酉、四课上神 酉亥巳未、三传 亥丑卯，四上神和中末传皆阴，初传亥又来自四课上神；六阴课主体规则全部命中。',
                        '2024-01-16T21:00',
                        self::DEFAULT_BIRTH,
                        self::DEFAULT_GENDER,
                        [],
                ...
                'source_examples' => [
                    ...
                    [
                        ...
                        'path' => '六阳正文例·原文参考盘',
                        'source' => '《六壬大全》正文',
                        'detail' => '《大全》正文给出“甲午日干上子，六阳遇退间传，为倒拔蛇，名悖戾；及兼初传戌财，引入中末鬼乡”。其中干上子、四课三传全阳、退间传 戌申午 同盘成立的条件与当前生产盘取传机制互斥；2024-2026 全部甲午日 × 12 代表时辰扫描亦未出现三传=戌申午 的盘。生产算法与 matcher 均未变动，仅作为原文参考盘入库。',
                    ],
                    [
                        'label' => '己卯日酉加未·六阴遇昼将入夜',
                        'path' => '六阴正文例·现代完整复现',
                        'source' => '《六壬大全》正文',
                        'detail' => '《大全》正文给出“如己卯日酉加未，六阴遇昼将入夜，昏迷尤甚”。2024-01-16 己卯日 21:00（亥时）生产盘完整复现：地盘未位上神酉、四课上神 酉亥巳未、三传 亥丑卯、四课三传皆阴，初传亥为四课上神之一；同时《大全》本例的“引入中末鬼乡”“支干遇盗气”等课后判断本轮仍按未程序化内容处理，不进入主体 matcher。',
                    ],
                    [
                        'label' => '五阳／五阴以人年命定之',
                        'path' => '年命填实扩展',
