            ...
            [
                ...
                'cases' => [
                    self::case(
                        ...
                        '《六壬大全·灾厄课》正文示例"亥年正月乙亥日卯时初传未加亥乘虎"的现代生产完整复现：亥年（nianzhi=11）病符戌、丧门丑、吊客酉、岁虎未；正月（yuezhi=2）丧车未、游魂亥、伏殃酉、三丘丑、五墓未。初传未同时命中丧车、五墓、岁虎三路；选 06:47 卯时日出后 13 分钟以满足"未乘虎"细节，与《大全》正文"未……加亥，乘虎"完整对应。',
                        '1923-03-03T06:47',
                        '1900-01-01T00:00',
                    ),
                ],
                'source_examples' => [
                    ['label' => '亥年正月乙亥日卯时初传未乘虎', 'path' => '正文·月神丧车 + 岁神岁虎 同支重叠 + 初传乘虎', 'source' => '《六壬大全·灾厄课》正文', 'detail' => '亥年正月乙亥日卯时，初传未；月建寅的丧车=未、亥年的岁虎=未，初传未同时命中两路；日出后 06:47 起初传未乘白虎，与《大全》"未……加亥，乘虎"完整对应。生产复现时间 1923-03-03 06:47，盘面三路命中：丧车（又名丧魂）、五墓、岁虎；初传乘白虎。'],
                ],
            ],
        ];
    }
