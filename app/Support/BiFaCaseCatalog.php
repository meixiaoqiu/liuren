...
final class BiFaCaseCatalog
{
    ...
    private const CASES = [
        ...
        ['case_id' => 'bifa.09.daquan-jia-zi-stem', 'law_code' => 'bifa.09', 'label' => '甲子日·戌申午·就干上子生', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_stem_support'], 'reason' => '正文标准例；无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-ding-mao', 'law_code' => 'bifa.09', 'label' => '丁卯日·干上亥', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_stem_support'], 'reason' => '正文列例，无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-yi-hai', 'law_code' => 'bifa.09', 'label' => '乙亥日·干上酉', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_stem_support'], 'reason' => '正文列例，无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-wu-yin', 'law_code' => 'bifa.09', 'label' => '戊寅日·干上申', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_stem_support'], 'reason' => '正文列例，无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-geng-xu', 'law_code' => 'bifa.09', 'label' => '庚戌日·干上午', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_stem_support'], 'reason' => '正文列例，无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-xin-wei', 'law_code' => 'bifa.09', 'label' => '辛未日·干上丑', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_stem_support'], 'reason' => '正文列例，无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-wu-wu', 'law_code' => 'bifa.09', 'label' => '戊午日·干上辰', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_stem_support'], 'reason' => '正文列例，无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-ji-si', 'law_code' => 'bifa.09', 'label' => '己巳日·干上酉', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_stem_support'], 'reason' => '正文列例，无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-xin-you', 'law_code' => 'bifa.09', 'label' => '辛酉日·干上亥', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_stem_support'], 'reason' => '正文列例，无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-ren-shen', 'law_code' => 'bifa.09', 'label' => '壬申日·干上寅', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_stem_support'], 'reason' => '正文列例，无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-geng-chen', 'law_code' => 'bifa.09', 'label' => '庚辰日·干上子', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_stem_support'], 'reason' => '正文列例，无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-jia-zi-branch', 'law_code' => 'bifa.09', 'label' => '甲子日·辰午申·就支上之生', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_branch_support'], 'reason' => '正文财受上下夹克标准例；无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-geng-zi-ground', 'law_code' => 'bifa.09', 'label' => '庚子日·三传水局·日干坐辰受生', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_ground_support'], 'reason' => '正文标准例；无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-fate-ding', 'law_code' => 'bifa.09', 'label' => '本命乘丁坐长生·正文通则', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['fate_ding_on_growth'], 'reason' => '正文只给通则，没有人物出生时间与完整起课时间，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-ding-hai-failed', 'law_code' => 'bifa.09', 'label' => '丁亥日·终不能逃生', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_failed'], 'reason' => '正文昴星夜占例，未给完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-ren-wu-wealth', 'law_code' => 'bifa.09', 'label' => '壬午日·辰酉寅·避难逃生得财', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['escape_to_wealth'], 'reason' => '正文标准例；无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        // 丙寅日是《六壬大全》明确的求财反例："见在之财落空，又焉能求外来之财也。"
        // 该案例代表「日干下临财乡」路径不成立，PHP 工程口径上 routes 必须留空，
        // 绝不被 casesByMatchedRoutes('bifa.09', [...]) 的任何 route 命中；
        // 但 reason 字段仅展示给用户，禁止出现 routes / 筛选 / 命中 等工程术语。
        ['case_id' => 'bifa.09.daquan-bing-yin-counterexample', 'law_code' => 'bifa.09', 'label' => '丙寅日·见在之财落空的反例说明', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => [], 'reason' => '正文作求财反例，仅供研究比较，不代表「日干下临财乡」成立；因古籍未给完整公历时间，仅作原文参考，不回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-ren-yin', 'law_code' => 'bifa.09', 'label' => '壬寅日·舍益就损', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['abandon_benefit_for_loss'], 'reason' => '正文标准例；无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
        ['case_id' => 'bifa.09.daquan-yi-you-correction', 'law_code' => 'bifa.09', 'label' => '乙酉日·《大全》误列 / 《琐记》校正', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['abandon_benefit_for_loss'], 'reason' => '保留《大全》原文归类，程序依程树勋校勘归入舍益就损。无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》；程树勋《壬学琐记》'],
        ['case_id' => 'bifa.09.daquan-xin-chou-correction', 'law_code' => 'bifa.09', 'label' => '辛丑日·《大全》误列 / 《琐记》校正', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => ['abandon_benefit_for_loss'], 'reason' => '保留《大全》原文归类，程序依程树勋校勘归入舍益就损。无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》；程树勋《壬学琐记》'],
