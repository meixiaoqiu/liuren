...
final class BiFaCaseCatalog
{
    ...
    private const CASES = [
        ...
        [
            ...
            'reason' => '乙未日属甲午旬，旬首午、旬尾卯；乙寄辰，干上卯恰为旬尾；支上午恰为旬首——天盘[日干寄宫]=旬尾 且 天盘[日支]=旬首，命中第二法 A 路。本案例使用 1986-08-19 13:00 现代公历日期，经 PanCalculator 真实起盘复现（古籍未给出现代日期，故按"古籍条文 + 现代起盘"组合登记）。',
            'source' => '《六壬大全·毕法赋》第二法·乙未日周而复始格条',
        ],
        [
            ...
            'reason' => '乙丑日属甲子旬，旬首子、旬尾酉；乙寄辰，干上子恰为旬首；支上酉恰为旬尾——天盘[日干寄宫]=旬首 且 天盘[日支]=旬尾，命中第二法 B 路镜像结构。',
            'source' => '《六壬大全·毕法赋》第二法·乙丑日周而复始格条',
        ],
        [
            ...
            'reason' => '乙巳日四建为太岁子、月建申、日支巳、占时酉；本盘四课地支集合含 {子、申、巳、丑、酉}，四建皆在集合内，命中第二法 C 路天心格（《毕法赋》正文口径）。',
            'source' => '《六壬大全·毕法赋》第二法·天心格条',
        ],
        [
            ...
            'reason' => '辛亥日三传戌酉申；本盘四课地支集合含 {酉、申、亥、戌}，三传尽在集合内，命中第二法 D 路回还格。本案例使用 1986-09-04 11:00 现代公历日期，经 PanCalculator 真实起盘复现（古籍"辛亥日戌酉申"未给出现代日期，故按"古籍条文 + 现代起盘"组合登记）。',
            'source' => '《六壬大全·毕法赋》第二法·回还格条',
        ],
    ];
}
