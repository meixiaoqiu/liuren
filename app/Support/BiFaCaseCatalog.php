...
final class BiFaCaseCatalog
{
    ...
    private const CASES = [
        ...
        [
            'case_id' => 'bifa.01.ding-si-gui-lin-gan-zhi-gang-xingnian',
            'law_code' => 'bifa.01',
            'label' => '丁巳日·贵临干支拱行年',
            'source_type' => 'daquan',
            'status' => 'executable',
            ...
            'people' => [],
            'routes' => ['gui_lin_gan_zhi_gang_nianming'],
            'reason' => '昼贵亥加临丁干寄宫未，夜贵酉加临日支巳，干支前后夹拱行年午。',
            'source' => '《六壬大全·毕法赋》第一法·丁巳日条',
        ],
        [
        ...
        [
            'case_id' => 'bifa.01.ding-hai-gan-zhi-bing-chu-zhong',
            'law_code' => 'bifa.01',
            'label' => '丁亥日·干支并初中拱地盘贵人',
            'source_type' => 'daquan',
            ...
            'reason' => '古籍条文示例：丁日伏吟初传卯、中传巳、末传未；干支与初中同拱夜贵酉（或昼贵亥）。完整盘面细节尚未在通行本中给出，仅作 reference_only。',
            'source' => '《六壬大全·毕法赋》第一法·"若干支并初中及中末拱地贵"条文',
        ],
        ...
        [
            ...
            'people' => [],
            'routes' => ['yin_gan'],
            'reason' => '用于验证引从天干分格在缺人物资料时仍可判定；命盘沿用庚辰日 bifa.01.geng-chen-yin-gan 同源盘面，但移除 context.people，迫使程序以"无本命/行年"路径返回。',
            'source' => '程序验证案例·用于覆盖 yin_gan 在无人物资料下的命中路径',
        ],
        [
        ...
        [
            ...
            'people' => [],
            'routes' => ['gui_lin_gan_zhi_gang_nianming'],
            'reason' => '用于验证 E 分格在仅本命存在、行年缺失的情况下能正常判定；与 bifa.01.ding-you-gui-lin-gan-zhi-gang-nianming 共用盘面，person 结构只保留 nianming。',
            'source' => '程序验证案例·用于覆盖 people 部分缺失边界',
        ],
        [
            ...
            'people' => [],
            'routes' => ['gui_lin_gan_zhi_gang_nianming'],
            'reason' => '用于验证 E 分格在仅行年存在、本命缺失的情况下能正常判定；person 结构只保留 xingnian。',
            'source' => '程序验证案例·用于覆盖 people 部分缺失边界',
        ],
        [
