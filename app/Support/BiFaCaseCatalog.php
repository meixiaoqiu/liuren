...
final class BiFaCaseCatalog
{
    ...
    private const CASES = [
        ...
        // 该案例代表「日干下临财乡」路径不成立，故 routes 留空，绝不得被 routes 筛选命中。
        ['case_id' => 'bifa.09.daquan-bing-yin-counterexample', 'law_code' => 'bifa.09', 'label' => '丙寅日·见在之财落空的反例说明', 'source_type' => 'daquan', 'status' => 'reference_only', 'datetime' => null, 'birth' => null, 'gender' => null, 'people' => [], 'routes' => [], 'reason' => '正文作求财反例，仅供研究比较，不代表「日干下临财乡」路径成立；routes 留空，不得被 routes 筛选命中。无完整公历 datetime，不得回填现代时间。', 'source' => '《六壬大全·毕法赋》第九法·卷九《毕法赋上》'],
