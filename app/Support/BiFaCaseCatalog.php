...
final class BiFaCaseCatalog
{
    ...
    private const CASES = [
        ...
        [
            ...
            'reason' => '《六壬大全·毕法赋》第四法催官使者条：原文仅描述「官星乘白虎临日干」抽象规则，无完整公历课例。',
            'source' => '《六壬大全·毕法赋》第四法·催官使者条',
        ],
        [
            'case_id' => 'bifa.04.daquan-cui-guan-talisman',
            'law_code' => 'bifa.04',
            'label' => '正文结构·催官符·辛未日午官亥卯未木局',
            'source_type' => 'daquan',
            'status' => 'reference_only',
            'datetime' => null,
            'birth' => null,
            ...
            'reason' => '《六壬大全·毕法赋》第四法催官符条；具体释义（《六壬粹言》辛未日午官、亥卯未木局生午火官星）作为辅助注脚，正文主体出自《大全》。原文无完整公历课例。',
            'source' => '《六壬大全·毕法赋》第四法·催官符条（《六壬粹言》辅助释义）',
        ],
        [
            ...
            'reason' => '《六壬大全·毕法赋》第四法父母爻条：原文给出父母爻定义与「日辰三传年命六处」检查结构，无完整公历课例。',
        ...
        [
            ...
            'reason' => '《六壬大全·毕法赋》第四法长生作贵人条：原文给出「己日夜贵申为长生贵人」典型示例，无完整公历课例。',
